...
namespace KWS
{
    internal static class MeshUtils
    {
        ...
        //public static GraphicsBuffer InitializeInstanceArgsGraphicsBuffer(Mesh instancedMesh, int instanceCount, GraphicsBuffer argsBuffer)
        //{
        //    if (instancedMesh == null) return argsBuffer;
        ...
        //    if (argsBuffer == null) argsBuffer = new GraphicsBuffer(GraphicsBuffer.Target.IndirectArguments, 1, _args.Length * sizeof(uint));
        ...
        public static Mesh CreateCubeMesh()
        {
            ...
            var decalMesh = new Mesh {hideFlags = HideFlags.DontSave};
